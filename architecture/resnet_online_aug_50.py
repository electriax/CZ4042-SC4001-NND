## File exported from Jupyter Notebook resnet_training.ipynb
...
# Save the history
torch.save(history, 'history_baseline.pth')
print("Model saved as resnet_baseline.pth and history saved as history_baseline.pth")
